...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/Sakura-Byte/sub2api/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="Sakura-Byte/sub2api"
...
Documentation=https://github.com/Sakura-Byte/sub2api
